<template>
  <div class="relative" v-if="show">
    <button class="btn z-20 flex bottom-0 right-0 fixed cursor-pointer flex shrink-0 grow-0 justify-around align-center
...
import StartGameIcon from '../icons/StartGameIcon.vue';
